...
class ExperimentLogger:
    ...
    def __init__(self, base_log_dir, prefix='vivit-training'):
        """
        Initialize experiment logger.
        
        Args:
            base_log_dir (str): Base directory for all logs
            prefix (str, optional): Prefix for the log directory name. Defaults to 'vivit-training'.
        """
        ...
        # Setup logger
        self.logger = logging.getLogger('ViViTClassifier')
