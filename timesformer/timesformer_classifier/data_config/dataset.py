...
class VideoDataset(Dataset):
    def __init__(self, root_dir, mode='train', sampling_method='uniform', 
        ...
        """
        Initialize the dataset for TimeSformer model training with custom frame sampling.
        
        Args:
            root_dir (str): Root directory containing dataset folders
            mode (str): One of 'train', 'val', 'test', or 'inference'
        ...
        # Support inference mode where we might be passed a direct file path
        if mode == 'inference':
    ...
    def __getitem__(self, idx):
        ...
        if self.is_inference:
            # In inference mode, we don't have a list of videos, just the root_dir
            ...
            try:
                ...
                for frame_idx in frame_indices:
                    try:
                        ...
                        # Resize to 224x224 as expected by TimeSformer
